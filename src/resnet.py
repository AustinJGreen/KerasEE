...
def build_resnet50():
    ...
    x = conv_block(x, 3, [256, 256, 1024], stage=4, block='a', freeze=True)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='b', freeze=True)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='c', freeze=True)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='d', freeze=True)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='e', freeze=True)
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='f', freeze=True)
